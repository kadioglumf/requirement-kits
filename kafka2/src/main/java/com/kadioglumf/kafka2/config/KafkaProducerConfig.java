package com.kadioglumf.kafka2.config;

import com.kadioglumf.kafka2.config.data.KafkaConfigData;
import com.kadioglumf.kafka2.config.data.KafkaProducerConfigData;
...
public class KafkaProducerConfig<K extends Serializable, V extends String> {
